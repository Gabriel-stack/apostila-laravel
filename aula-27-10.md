...
No material anterior, coloquei o seguinte HTML:
...
Se você tentar acessar a rota de criação de posts, vai dar um erro, pois ainda não estamos passando as categorias para a view. Para isso, vamos alterar o método `create` do controlador `PostController` para:
